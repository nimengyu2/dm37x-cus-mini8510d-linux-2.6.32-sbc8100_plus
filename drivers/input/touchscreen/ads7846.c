...
static int ads_cal[7] = {-26882, 27, 53450708, 29, 16815, -1247548, 65536};
...
#ifdef CONFIG_ADS_SCALED_EV
                x_abs = (ads_cal[0]*x + ads_cal[1]*y + ads_cal[2])/ads_cal[6];
                y_abs = (ads_cal[3]*x + ads_cal[4]*y + ads_cal[5])/ads_cal[6];
...
static void ads7846_rx_val(void *ads)
{
	 ...
	 */
	val = be16_to_cpup((__be16 *)t->rx_buf) >> /*3*/4;
